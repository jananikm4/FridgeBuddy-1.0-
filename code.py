...
# Custom Injectable Styling Layer mapping your custom palette perfectly
st.markdown("""
<link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
    /* Full Page Palette Background - Deep Midnight Blue */
    [data-testid="stAppViewContainer"] { 
        background-color: #0052cc !important; 
    }
    
    /* Core Typography Base Rules */
    html, body, [class*="css"], .stApp, .main-title, .main-subtitle {
        font-family: 'Merriweather', serif !important;
        color: #f4f5f7 !important;
    }
    
    /* Vibrant Header Components */
    .main-title { 
        font-size: 2.75rem; 
        font-weight: 700; 
        color: #f4f5f7 !important; 
    ...
    /* Custom Context-Aware Inventory Panels */
    .action-panel { 
        border-radius: 12px; 
        padding: 1.5rem; 
        height: 100%; 
    ...
    .recipe-bg { 
        background: linear-gradient(135deg, #f4f5f7 0%, #ffb3c6 100%); 
        border: 2px solid #2684ff; 
    }
    .mascot-bg { 
        background: linear-gradient(135deg, #f4f5f7 0%, #2684ff 100%); 
        border: 2px solid #0052cc; 
    }
    
    /* Live Matrix Row Alignment Overrides */
    .matrix-row {
    ...
    /* Make Metric Text Highly Visible against Background */
    ...
    /* Fixed Sidebar Inputs and Text Elements */
